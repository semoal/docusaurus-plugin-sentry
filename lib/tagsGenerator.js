...
const constructHeadTags = (opts) => process.env.NODE_ENV !== 'production' && opts.onlyProduction
    ? undefined
    : enrichers.map(enricher => { var _a; return (_a = enricher.condition(opts)) !== null && _a !== void 0 ? _a : enricher.generate(opts); }).filter(value => value);
